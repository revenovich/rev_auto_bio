...
def getDays():
    ...
    month = date.month
    year = date.year
    datestart = Date(9, 8, 2015)
    datenow = Date(day, month, year)

    return getDifference(datestart, datenow)

# This code is contributed by Smitha

# I got it from https://www.geeksforgeeks.org/find-number-of-days-between-two-given-dates/
# Edit by me (Revenovich)
